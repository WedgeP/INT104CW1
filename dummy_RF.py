...
# 设置参数搜索网格，加入PCA和随机森林参数
param_grid = {
    'pca__n_components': [0.5,0.7,0.8,0.85, 0.99],
    'classifier__base_estimator__n_estimators': [100, 200],
    'classifier__base_estimator__max_depth': [None, 10, 15],
    'classifier__base_estimator__min_samples_split': [2, 5],
    'classifier__confidence_threshold': [0.3,0.4, 0.5, 0.6,0.7,0.8,0.9],
